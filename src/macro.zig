...
pub fn require(condition: bool, error_message: []const u8) void {
...
pub fn keylet_hook_state(buf_out: []const u8, account_id: []const u8, key: []const u8, namespace: []const u8, hook_name: []const u8) i64 {
...
pub fn keylet_amendments(buf_out: []const u8) i64 {
    return util_keylet(buf_out, .AMENDMENTS, 0, 0, 0, 0, 0, 0);
}

pub fn keylet_fees(buf_out: []const u8) i64 {
    return util_keylet(buf_out, .FEES, 0, 0, 0, 0, 0, 0);
}

pub fn keylet_negative_unl(buf_out: []const u8) i64 {
    return util_keylet(buf_out, .NEGATIVE_UNL, 0, 0, 0, 0, 0, 0);
}

pub fn keylet_emitted_dir(buf_out: []const u8) i64 {
    return util_keylet(buf_out, .EMITTED_DIR, 0, 0, 0, 0, 0, 0);
}

pub fn keylet_skip(buf_out: []const u8, ledger_index: u32) i64 {
    return util_keylet(buf_out, .SKIP, ledger_index, if (ledger_index > 0) 1 else 0, 0, 0, 0, 0);
}

pub fn keylet_line(buf_out: []const u8, hi_account_id: []const u8, low_acount_id: []const u8, currency: []const u8) i64 {
...
pub fn keylet_quality(buf_out: []const u8, keylet: []const u8, high: []const u8, low: []const u8) i64 {
...
pub fn keylet_deposit_preauth(buf_out: []const u8, account_id1: []const u8, account_id2: []const u8) i64 {
...
pub fn keylet_check(buf_out: []const u8, account_id: []const u8, comptime T: type, seq_or_key: T) i64 {
    switch (T) {
...
pub fn keylet_escrow(buf_out: []const u8, account_id: []const u8, comptime T: type, seq_or_key: T) i64 {
    switch (T) {
...
pub fn keylet_nft_offer(buf_out: []const u8, account_id: []const u8, comptime T: type, seq_or_key: T) i64 {
    switch (T) {
...
pub fn keylet_paychan(buf_out: []const u8, account_id1: []const u8, account_id2: []const u8, comptime T: type, seq_or_key: T) i64 {
    switch (T) {
